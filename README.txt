...
Another concequence and a potential feature of collecting this data specifically when tying an address to your ID is the to possibly to use a TikTok handle as your public address in wallets that opt to support this feature using this contract. This could be implimented on any social platform and make crypto adoption easier, a cheap alternative to ENS (when using the Polygon(MATIC) network). 
